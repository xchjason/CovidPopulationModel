...
def spreadsheet_to_json(link):
	...
	jdata['rho']['M']['value'] = {'0': {'loc': data[21][4], 'scale': data[21][5]},'1': {'a': data[22][4], 'b': data[22][5]}}
	jdata['rho']['G'] = {}
	...
	jdata['rho']['I']['value'] = {'0': {'loc': data[25][4], 'scale': data[25][5]},'1': {'a': data[26][4], 'b': data[26][5]}}
	jdata['rho']['D'] = {}
