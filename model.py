...
class CovidModel(tf.keras.Model):
    ...
    def call(self, inputs, debug_disable_prior=False, return_all=False):
        ...
        r_t, warmup_asymp, warmup_mild, warmup_extreme, train_status = self._parse_inputs(inputs)
    ...
    def _parse_inputs(self, inputs):
        ...
        (r_t,
         warmup_asymp_not_vaxxed, warmup_asymp_vaxxed,
         warmup_mild_not_vaxxed, warmup_mild_vaxxed,
         warmup_extreme_not_vaxxed, warmup_extreme_vaxxed, train_status) = inputs
        ...
        return r_t, warmup_asymp, warmup_mild, warmup_extreme, train_status
